...
const navLinks = [
    ...
    {
        name1: "Features",
        desc:"loream ipsum dolor sit amet, consectetur adipiscing elit. Sed .",
        price:"1eth",
        owner:"0x123...abc",
...
const expCards = [
    {
      ...
      "loream ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
            "Developed a decentralized application (dApp) for secure data storage using Ethereum smart contracts"
        ],
    },
    {
       imgPath: "/images/project.2.png",
       
        title: "multi send ether",
